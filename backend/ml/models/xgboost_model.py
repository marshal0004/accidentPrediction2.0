"""
XGBoost Classifier for Accident Severity Prediction.
...
Why XGBoost:
    ...
    - Typically top performer on tabular classification tasks
"""
...
def build_xgboost():
    """Build and return an XGBoost classifier with tuned hyperparameters."""
    model = XGBClassifier(
        n_estimators=300,
        max_depth=8,
        learning_rate=0.1,
