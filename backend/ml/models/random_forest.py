...
Why Random Forest:
    ...
    - Provides built-in feature importance via Gini impurity
    - Parallelizable (n_jobs=-1) for fast training
"""
...
def build_random_forest():
    """Build and return a Random Forest classifier with tuned hyperparameters."""
...
def train_random_forest(
    ...
    """
    Train Random Forest model end-to-end.
    ...
    # --- Save Model ---
    model_path = os.path.join(save_dir, "RandomForest_model.joblib")
